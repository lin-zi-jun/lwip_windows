...
public class PushActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("pushactivity onCreate in");
        ...
        mDeviceID = Secure.getString(this.getContentResolver(), Secure.ANDROID_ID);         
  	    ...
  	    final Button pubButton = ((Button) findViewById(R.id.Pub_button));
			...
			public void onClick(View v) {
		    	...
		    	System.out.println("pushactivity actionStart");
		    	System.out.println("pushactivity actionStart one more");
  	  ...
  	  pubButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				TextView edit = (TextView)findViewById(R.id.pubtext);
				String str = edit.getText().toString();
				if(str != null)
				    PushService.actionPub(getApplicationContext(), str);		        								
