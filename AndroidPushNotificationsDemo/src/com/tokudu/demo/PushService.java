...
public class PushService extends Service
{
	...
	private static final String		MQTT_HOST = "121.42.188.97";
	...
	public static String pubdata = "easyIoT";
	...
	public static void actionPub(Context ctx, String data) {
		Intent i = new Intent(ctx, PushService.class);
		pubdata = data;
	...
	private synchronized void pub(){
		// Do nothing, if the service is not running.
		if (mStarted == false) {
			Log.w(TAG, "Attempt to pub connection not active.");
			return;
		}
		
		if (mConnection != null) {
			try {
				mConnection.publishToTopic("easyIoT", pubdata);
